-- Schema para o banco de dados do Sistema de Controle de Territórios
...
CREATE TABLE IF NOT EXISTS imoveis (
    ...
    tipo_portaria TEXT, -- '24h', 'eletronica', 'diurna', 'sem', 'outro'
...
CREATE TABLE IF NOT EXISTS atendimentos (
    ...
    data TEXT NOT NULL,
    resultado TEXT, -- 'positivo', 'ocupante-ausente', 'recusou', 'visitado'
    observacoes TEXT,
